...
$icons = wsg_icons();
if ( ! $icons ) { echo wsg_wrap( 'icons', '<p class="wsg-note">' . esc_html__( 'No icon set registered. The theme registers assets/icons/*.svg through the WordPress 7.1 Icons API.', 'weave-style-guide' ) . '</p>', $attributes ); return; }
...
$inner .= '</div>';
echo wsg_wrap( 'icons', $inner, $attributes );
