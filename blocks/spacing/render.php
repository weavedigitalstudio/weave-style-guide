...
if ( ! $sizes ) { echo wsg_wrap( 'spacing', '<p class="wsg-note">' . esc_html__( 'No spacing presets in theme.json.', 'weave-style-guide' ) . '</p>', $attributes ); return; }
...
echo wsg_wrap( 'spacing', $inner, $attributes );
