...
namespace WeaveStyleGuide\Updater;
...
final class GitHubUpdater {
    ...
    private string $github_repo    = 'weave-style-guide';
    ...
    private const CACHE_KEY              = 'wsg_github_response';
    ...
    public function plugin_info(mixed $res, string $action, object $args): mixed {
        ...
        $info                 = new \stdClass();
        $info->name           = $plugin_data['Name'] ?? 'Weave Style Guide';
        ...
        $info->sections       = [
            'description' => $plugin_data['Description'] ?? 'An auto-generated styles page for block themes.',
